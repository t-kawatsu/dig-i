...
<meta name="keywords" content="<@s.text name="app.site.name"/>,ディギー,管理画面" >
      ...
      <div class="clearfix">
        <nav id="c-site-nav">
          <ul class="c-h-menu clearfix">
		    <#if isLogined!false>
		      <#assign menu = {
			    "Resource":url('/resource/index'), 
			    "Information":url('/information/index'),
			    ...
			    "User":url('/user/index'),
			    "LanguageSiteInformation":url('/language-site-information/index'),
