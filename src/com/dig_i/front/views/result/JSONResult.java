package com.dig_i.front.views.result;
...
/**
 * @see http
 *      ://javasourcecode.org/html/open-source/struts/struts-2.2.3/org/apache
 *      /struts2/json/
 */
public class JSONResult implements Result {
	...
	private String createJSONString(HttpServletRequest request,
			Object rootObject) throws JSONException {
		if (rootObject == null) {
			return "";
		}
