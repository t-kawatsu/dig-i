...
public abstract class AbstractForm implements Serializable {
	...
	public Map<String, String> getEnumSelectList(
			Class<? extends Enum<?>> eclazz, boolean includeUndefined) {
	...
	public Map<String, String> getEnumSelectList(
			Class<? extends Enum<?>> eclazz, String code) {
	...
	public Map<String, String> getSettingSelectList(final String settingCode) {
		LanguageSetting languageSetting = languageSettingDao
				.findByCode(settingCode);
